...
import 'package:masterdapp/algorand_transaction_tester.dart';
import 'package:masterdapp/ethereum_transaction_tester.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  EthereumTransactionTester _transactionTester = EthereumTransactionTester();
  ...
  void _changeNetworks(String? network) {
    ...
    switch (newNetwork) {
      case NetworkType.algorand:
        _transactionTester = AlgorandTransactionTester() as EthereumTransactionTester;
        break;
